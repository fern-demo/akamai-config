...
If your configuration includes subWorkers, refer to the details in the [JWT authentication token security for subWorkers](enable-enhanced-debug-headers.md#jwt-authentication-token-security-for-subworkers) section for more information. 
