...
- Make sure EdgeWorkers is in your contract. You can find the list of products within your account in <<PORTAL_NICKNAME>> under **Contracts**. Contact your <<COMPANY_NICKNAME>> support team to enable EdgeWorkers if necessary.

- You need different permissions to access API functions. You can manage these permissions in <<PORTAL_NICKNAME>>. Learn more about the [access control model](https://techdocs.akamai.com/iam/docs/about-access-control-model). See [Product limits](doc:limitations) for a list of supported delivery products.
...
- Add a rule in Property Manager to enable the EdgeWorkers behavior. See [Add the EdgeWorkers behavior](doc:add-the-edgeworkers-behavior).
...
> 👍 Provide feedback or ask a question in the [developer community](https://community.akamai.com/customers/s/developer-community). You can also contact your <<COMPANY_NICKNAME>> account representative for support. We want to hear from you!
