...
- Confirm that you have the entitlement for the EdgeWorkers service in your contract. See [Limitations](doc:common-limitations) for a list of supported delivery products.

- Review [Get Started with APIs](https://techdocs.akamai.com/developer/docs/set-up-authentication-credentials) for instructions on setting up authentication tokens to access any <<COMPANY_NICKNAME>> API. These tokens appear as custom hostnames that look like this:
